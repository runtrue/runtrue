use crate::{
    ...
    FailureResolution, FeatureProfileId, ProviderContractError, SessionState, TerminalOutcome,
};
...
impl BisimLifecycleObservation {
    pub fn validate(&self) -> Result<(), ProviderContractError> {
        ...
        if terminal != self.terminal_outcome.is_some()
...
pub struct BisimPortableObservation {
    ...
    pub evidence_identity_digest: ContentDigest,
...
impl BisimPortableObservation {
    ...
    pub fn portable_digest(&self) -> Result<ContentDigest, ProviderContractError> {
        ...
        struct Portable<'a> {
            ...
            evidence_identity_digest: &'a ContentDigest,
            backend_security_result_digest: &'a ContentDigest,
        }
        canonical_digest(
            ...
            &Portable {
                ...
                backend_security_result_digest: &self.backend_security_result_digest,
            },
        )
    }
