...
require("            image: runtrue-autoscaler")
require("            artifact: runtrue-autoscaler-amd64")
require("            artifact: runtrue-autoscaler-arm64")
...
require("          for component in runtrue-server runtrue-runner runtrue-autoscaler; do")
require("      - name: Attest published autoscaler image")
