...
An externally composed workflow frontend may request immutable repository
actions through the generic resolver boundary. Core does not ship a provider
catalog, source-action builder, or container-build service; a distribution must
provide and review that integration independently.
